...
export const team = [
  {
    ...
    image: "/images/jerome-casino.webp",
  },
];
...
export const activities: Activity[] = [
  // ========== INTÉRIEUR ==========
  {
    ...
    category: "interieur",
    image: "/images/sens-conscience.webp",
    images: [
      "/images/sens-conscience.webp",
      "/images/sens-conscience-3.webp",
      "/images/sens-conscience-2.webp",
      "/images/sens-conscience-4.webp",
      "/images/sens-conscience-6.webp",
      "/images/sens-conscience-aromes.webp",
      "/images/sens-conscience-langue-signes.webp",
      "/images/sens-conscience-silence.webp",
      "/images/sens-conscience-silence-2.webp",
      "/images/sens-conscience-bulle.webp",
    ],
  ...
  },
  {
    ...
    name: "Energie C",
    category: "interieur",
    image: "/images/energie-c-3.webp",
    images: [
      "/images/energie-c-3.webp",
      "/images/energie-c.webp",
      "/images/energie-c-2.webp",
      "/images/energie-c-4.webp",
      "/images/energie-c-5.webp",
      "/images/energie-c-6.webp",
      "/images/energie-c-7.webp",
      "/images/energie-c-8.webp",
      "/images/energie-c-9.webp",
      "/images/energie-c-10.webp",
      "/images/energie-c-11.webp",
      "/images/energie-c-12.webp",
      "/images/energie-c-13.webp",
    ],
    excerpt: "L'étude des mouvements : transformer une tâche très simple en activité complexe grâce aux réactions en chaîne.",
    description: "Energie C explore l'énergie cinétique et l'étude des mouvements. Le principe : transformer une tâche en apparence très simple en une activité d'une complexité fascinante, grâce aux réactions en chaîne. Chaque équipe conçoit, assemble et déclenche sa propre machine, où chaque mouvement en entraîne un autre. Précision, coordination et créativité collective sont au cœur de cette expérience unique. Une création originale signée Latitude Organisation.",
  ...
  },
  {
    ...
    category: "interieur",
    image: "/images/fresque-peinture.webp",
    images: ["/images/fresque-peinture.webp", "/images/impressionnistes-nuit.webp", "/images/peinture-beaux-arts.webp"],
  ...
  },
  {
    ...
    category: "interieur",
    image: "/images/temps-x-1.webp",
    images: ["/images/temps-x-1.webp", "/images/temps-x-2.webp", "/images/temps-x-3.webp", "/images/temps-x-4.webp", "/images/temps-x-5.webp", "/images/temps-x-6.webp", "/images/temps-x-7.webp", "/images/temps-x-8.webp"],
  ...
  },
  {
    ...
    category: "interieur",
    image: "/images/cuisine-1.webp",
    images: ["/images/cuisine-1.webp", "/images/cuisine-2.webp", "/images/cuisine-3.webp"],
  ...
  },
  {
    ...
    name: "Oeno Academy",
    category: "interieur",
    image: "/images/oeno-academy-1.webp",
    images: ["/images/oeno-academy-1.webp", "/images/oeno-academy-2.webp", "/images/oeno-academy-3.webp"],
    excerpt: "Deux ateliers autour du vin : dégustation et création de sa propre étiquette.",
    description: "Oeno Academy se décline en deux ateliers complémentaires : un atelier dédié à la découverte et la dégustation des vins, et un atelier de création d'étiquettes où chaque équipe imagine et conçoit l'identité visuelle de sa propre bouteille. Culture, créativité et convivialité réunies autour d'une passion française. Une création originale signée Latitude Organisation.",
    duration: "2h à 3h",
    participants: "8 à 60",
  },
  {
    ...
    description: "Vous, qui tenez entre vos mains ce document, sachez qu'il recèle les secrets d'une nuit de fièvre et de lumière, où les pinceaux se mêlèrent au sang, et où les âmes d'artistes tremblèrent sous le poids de leurs passions.\n\nMon nom est Alphonse BERTILLON, inventeur des premières fiches d'identification criminelle, pionnier de la police scientifique. Je viens ici relater une affaire qui m'a été confiée et que nous n'avons pas entièrement résolu. J'ai laissé pour celui ou celle qui prendra connaissances de cette affaire, des indices, des objets, des fiches et des cartes qui permettront, je l'espère, de comprendre ce qu'il s'est réellement passé ce soir là.\n\nLes faits se déroulent en 1886, dans une galerie d'art récemment ouverte sur la rive droite de la Seine : La Galerie des Lumières. Ce soir là devait marquer le dîner de la veille du grand vernissage de l'exposition des peintres impressionnistes, ces rêveurs obstinés que l'Académie raille encore.\n\nMais à la tombée du soir, la fête tourne au cauchemar : le critique d'art Armand Dupré sera retrouvé sans vie, gisant parmi les tableaux.\n\nVotre enquête doit être minutieuse, trouvez le mobile et les preuves irréfutables afin de désigner le nom de l'assassin. Bonne chance à vous…",
  ...
  },
  {
    ...
    name: "Zen Attitude",
    category: "interieur",
    image: "/images/zen-attitude.webp",
    images: ["/images/zen-attitude.webp", "/images/zen-attitude-2.webp"],
  ...
  },
  {
    ...
    category: "interieur",
    image: "/images/compagnons-1.webp",
    images: ["/images/compagnons-1.webp", "/images/compagnons-vitraux-1.webp", "/images/compagnons-vitraux-2.webp", "/images/compagnons-vitraux-3.webp", "/images/compagnons-pierre.webp"],
  ...
  },
  {
    ...
    category: "interieur",
    image: "/images/cocktail-bar.webp",
    images: [
      "/images/cocktail-bar.webp",
      "/images/cocktail-workshop.webp",
      "/images/cocktail-setup.webp",
      "/images/cocktail-spirits.webp",
    ],
  ...
  },
  {
    ...
    category: "interieur",
    image: "/images/brocanteurs-1.webp",
    images: ["/images/brocanteurs-1.webp", "/images/brocanteurs-2.webp", "/images/brocanteurs-3.webp"],
...

  {
    ...
    name: "Koh Lantable",
    category: "interieur",
    image: "/images/koh-lantable-ambiance.webp",
    images: [
      "/images/koh-lantable-ambiance.webp",
      "/images/koh-lantable-degustation.webp",
      "/images/koh-lantable-kapla.webp",
      "/images/koh-lantable-poteaux.webp",
      "/images/koh-lantable-puzzle.webp",
    ],
  ...
  // ========== EXTÉRIEUR ==========
  {
    ...
    name: "So British",
    category: "exterieur",
    image: "/images/so-british-beatles.webp",
    images: [
      "/images/so-british-beatles.webp",
      "/images/so-british-croquet.webp",
      "/images/so-british-karim.webp",
      "/images/so-british-the.webp",
      "/images/so-british-flechettes.webp",
      "/images/so-british-flechettes-2.webp",
      "/images/so-british-staff.webp",
    ],
  ...
  },
  {
    ...
    category: "exterieur",
    image: "/images/igloo-team.webp",
    images: [
      "/images/igloo-team.webp",
      "/images/ski-geant-team.webp",
      "/images/ski-fond-synthetique-1.webp",
      "/images/ski-fond-synthetique-2.webp",
      "/images/ski-fond-synthetique-3.webp",
    ],
  ...
  },
  {
    ...
    category: "exterieur",
    image: "/images/koh-lanta-groupe.webp",
    images: [
      "/images/koh-lanta-groupe.webp",
      "/images/koh-lanta-equilibre.webp",
      "/images/koh-lanta-faisanderie.webp",
      "/images/koh-lanta-kapla.webp",
      "/images/koh-lanta-tir-arc.webp",
    ],
  ...
  },
  {
    ...
    category: "exterieur",
    image: "/images/mysteres-montgolfiere.webp",
    images: [
      "/images/mysteres-montgolfiere.webp",
      "/images/mysteres-montgolfiere-interieur.webp",
      "/images/mysteres-montgolfiere-interieur-2.webp",
      "/images/mysteres-montgolfiere-personnages.webp",
      "/images/mysteres-montgolfiere-2.webp",
      "/images/mysteres-montgolfiere-3.webp",
      "/images/mysteres-montgolfiere-4.webp",
      "/images/mysteres-arbalete-2.webp",
      "/images/mysteres-caricature-1.webp",
      "/images/mysteres-caricature-2.webp",
      "/images/mysteres-caricature-3.webp",
    ],
    excerpt: "Un jeu d'enquête et de découverte au cœur d'une gentilhommière et de son territoire : tir à l'arbalète, caricatures mystères et défis inspirés de l'histoire du lieu.",
    description: "Les Mystères de la Gentilhommière invite vos équipes à explorer un domaine de caractère et le riche territoire qui l'entoure à travers un jeu d'enquête original conçu par Latitude Organisation. Tir à l'arbalète, reconnaissance de caricatures dans le noir, défis et énigmes inspirés de l'histoire du site et de ses environs — dont le berceau mondial de la montgolfière, Annonay — : chaque épreuve fait découvrir un lieu et une histoire de manière ludique et immersive.",
    isLatitudeOriginal: true,
    duration: "1/2 à journée",
    participants: "15 à 100",
  },
  {
    ...
    category: "exterieur",
    image: "/images/jeux-ferme.webp",
    images: [
      "/images/jeux-ferme.webp",
      "/images/jeux-ferme-2.webp",
      "/images/jeux-ferme-brouette.webp",
    ],
  ...
  },
  {
    ...
    name: "Archéo",
    category: "exterieur",
    image: "/images/archeo-rochefort.webp",
    images: [
      "/images/archeo-rochefort.webp",
      "/images/archeo-rochefort-2.webp",
      "/images/archeo-rochefort-3.webp",
      "/images/archeo-rochefort-4.webp",
      "/images/archeo-rochefort-5.webp",
      "/images/archeo-rochefort-6.webp",
      "/images/archeo-bilboquet.webp",
      "/images/archeo-tir-arc.webp",
      "/images/archeo-famille-2.webp",
      "/images/archeo-jerome.webp",
    ],
    excerpt: "Un tournoi sur le thème de l'archéologie et de l'histoire : succession d'épreuves pour désigner la meilleure équipe.",
    description: "Archéo plonge vos équipes dans un tournoi immersif sur le thème de l'archéologie et de l'histoire. Divisés en équipes, vos collaborateurs s'affrontent dans une succession d'épreuves : tir à l'arbalète, création de leur blason, quiz Indiana Jones, recherche d'artefacts cachés… Chaque défi cumule des points et désigne à l'issue de la journée la meilleure équipe. Compétition, coopération et immersion historique au programme. Une création originale signée Latitude Organisation.",
    isLatitudeOriginal: true,
    duration: "1/2 à journée",
  ...
  },
  {
    ...
    name: "Green Concept",
    category: "exterieur",
    image: "/images/green-concept-1.webp",
    images: ["/images/green-concept-1.webp", "/images/green-concept-2.webp", "/images/green-concept-3.webp"],
    excerpt: "Un team-building créatif qui utilise la seule matière non épuisable et non polluante : votre matière grise.",
    description: "Green Concept repose sur un principe simple : utiliser la seule matière première véritablement non épuisable et non polluante — votre matière grise et votre sens artistique. Vos équipes relèvent des défis créatifs qui mettent à l'épreuve imagination, ingéniosité et cohésion. Pas de ressources gaspillées, juste de l'intelligence collective et du talent. Un team-building original, malin et engagé. Une création originale signée Latitude Organisation.",
    isLatitudeOriginal: true,
    duration: "1/2 à journée",
    participants: "10 à 100",
  },
  {
    ...
    name: "Projet H",
    category: "exterieur",
    image: "/images/projet-h-1.webp",
    images: [
      "/images/projet-h-1.webp",
      "/images/projet-h-2.webp",
      "/images/projet-h-3.webp",
      "/images/projet-h-4.webp",
      "/images/projet-h-7.webp",
      "/images/projet-h-8.webp",
      "/images/projet-h-9.webp",
      "/images/projet-h-10.webp",
      "/images/projet-h-11.webp",
      "/images/projet-h-12.webp",
      "/images/projet-h-15.webp",
      "/images/projet-h-16.webp",
      "/images/projet-h-17.webp",
      "/images/projet-fontenille.webp",
    ],
  ...
  },
  {
    ...
    name: "Archimède",
    category: "exterieur",
    image: "/images/catapulte.webp",
    images: ["/images/catapulte.webp", "/images/catapulte-2.webp"],
    excerpt: "Un défi d'ingénierie collective : construire et tirer avec une catapulte fonctionnelle.",
    description: "Archimède met vos équipes au défi de concevoir et construire une catapulte fonctionnelle. Conception, assemblage et test grandeur nature : chaque équipe doit faire preuve d'ingéniosité et de coopération pour que sa machine frappe juste. Une activité outdoor spectaculaire qui combine réflexion, précision et esprit d'équipe. Une création originale signée Latitude Organisation.",
    isLatitudeOriginal: true,
    duration: "1/2 à journée",
    participants: "12 à 80",
  },
  {
    ...
    name: "Cybertraque",
    category: "exterieur",
    image: "/images/cybertraque-4.webp",
    images: ["/images/cybertraque-4.webp", "/images/cybertraque-3.webp", "/images/cybertraque-4.webp", "/images/cybertraque-5.webp", "/images/cybertraque-5b.webp"],
  ...
  },
  {
    ...
    images: ["/images/biathlon.webp", "/images/biathlon-montagne-neige.webp"],
  ...
  },
  {
    ...
    images: ["/images/orientation.webp", "/images/course-orientation.webp"],
  ...
  },
  {
    ...
    name: "Jeux du vin",
    category: "exterieur",
    image: "/images/vin-2.webp",
    images: ["/images/vin-2.webp", "/images/vin-1.webp", "/images/degustation-soiree-ext.webp"],
  ...
  },
  {
    ...
    name: "Samba",
    category: "exterieur",
    image: "/images/samba-1.webp",
    images: ["/images/samba-1.webp","/images/samba.webp"],
  ...
  },
  {
    ...
    name: "Agent secret",
    category: "exterieur",
    image: "/images/image-agent-secret.webp",
    images: ["/images/image-agent-secret.webp", "/images/jerome-et-pepito-peaky.webp"],
  ...
  },
  {
    ...
    category: "exterieur",
    image: "/images/impressionnistes-satillieu.webp",
    images: [
      "/images/impressionnistes-satillieu.webp",
      "/images/impressionnistes-corot.webp",
      "/images/impressionnistes-etangs.webp",
      "/images/impressionnistes-paillottes.webp",
    ],
  ...
  {
    slug: "rallyes-historiques",
    name: "Rallyes Historiques",
    category: "exterieur",
  ...
  },
  {
    ...
    category: "exterieur",
    image: "/images/image-chasse-au-tresor.webp",
    images: ["/images/image-chasse-au-tresor.webp", "/images/image-chasse-au-tresor2.webp"],
  ...
  },
  {
    ...
    category: "exterieur",
    image: "/images/rallye-2cv.webp",
    images: ["/images/rallye-2cv.webp"],
  ...
  },
  {
    ...
    images: ["/images/golf.webp", "/images/tiger-golf-1.webp", "/images/tiger-golf-2.webp"],
    excerpt: "Un team-building golf inspiré de Tiger Woods : 4 ateliers Pitch, Drive, Putt et Swing pour défier vos équipes.",
    description: "Tiger Academy est un team-building autour du golf, inspiré du légendaire Tiger Woods. Vos équipes s'affrontent sur 4 ateliers emblématiques : Pitch, Drive, Putt et Swing. Accessible à tous — même sans expérience du golf — chaque atelier allie précision, concentration et esprit de compétition. Un format ludique et original pour découvrir ce sport d'exception en équipe. Une création originale signée Latitude Organisation.",
    isLatitudeOriginal: true,
    duration: "1/2 à journée",
    participants: "15 à 80",
  },
  {
    ...
    category: "exterieur",
    image: "/images/formule-carton-3.webp",
    images: ["/images/formule-carton-3.webp", "/images/formule-carton-1.webp", "/images/formule-carton-2.webp"],
  ...
  },
  {
    ...
    name: "Trappeurs",
    category: "exterieur",
    image: "/images/trappeurs-1.webp",
    images: ["/images/trappeurs-1.webp", "/images/trappeurs-2.webp", "/images/trappeurs-3.webp", "/images/trappeurs-4.webp", "/images/trappeurs-5.webp"],
  ...
  },
  {
    ...
    name: "Biergarten",
    category: "exterieur",
    image: "/images/biergarten-1.webp",
    images: ["/images/biergarten-1.webp", "/images/biergarten-2.webp", "/images/biergarten-3.webp"],
    excerpt: "L'ambiance conviviale des jardins à bière allemands : jeux en bois, animations festives et bières artisanales en plein air.",
    description: "Le Biergarten transporte vos équipes dans l'atmosphère chaleureuse des jardins à bière bavarois. Jeux en bois géants, animations festives, dégustations de bières artisanales et gastronomie allemande : une animation outdoor conviviale et décalée qui fédère les équipes dans la bonne humeur.",
    duration: "2h à 1/2 journée",
    participants: "15 à 150",
  },
  {
    slug: "trophees-du-rugby",
    name: "Trophées du Rugby",
    category: "exterieur",
    image: "/images/trophees-rugby-1.webp",
    images: [
      "/images/trophees-rugby-1.webp",
      "/images/trophees-rugby-2.webp",
    ],
...
export const soireeEvents: SoireeEvent[] = [
  {
    slug: "bingo-musical",
    name: "Bingo Musical",
    image: "/images/bingo-1.webp",
    images: ["/images/bingo-1.webp", "/images/bingo-2.webp", "/images/bingo-3.webp", "/images/bingo-4.webp"],
  ...
  },
  {
    slug: "quiz-karaoke",
    name: "Quiz Karaoké",
    image: "/images/animation-soiree-groupe.webp",
    images: [
      "/images/animation-soiree-groupe.webp",
    ],
  ...
  },
  {
    ...
    images: [
      "/images/casino-roulette.webp",
      "/images/casino.webp",
      "/images/jerome-casino.webp",
    ],
  ...
  },
  {
    slug: "cabaret",
    name: "Cabaret",
    image: "/images/masque-venitien.webp",
    images: [
      "/images/masque-venitien.webp",
      "/images/soirée cabaret.webp",
    ],
  ...
  },
  {
    slug: "spectacle",
    name: "Spectacle",
    image: "/images/presentateurs.webp",
    images: [
      "/images/presentateurs.webp",
      "/images/animation-soiree-groupe.webp",
    ],
  ...
  },
  {
    slug: "caricature",
    name: "Caricature",
    image: "/images/caricature.webp",
    images: ["/images/caricature.webp"],
  ...
  },
  {
    ...
    image: "/images/theatre-ce-soir.webp",
    images: [
      "/images/theatre-ce-soir.webp",
    ],
...
export const incentiveItems: IncentiveItem[] = [
  {
    slug: "rallye-2cv",
    name: "Rallye 2CV",
    image: "/images/rallye-2cv-new.webp",
    images: ["/images/rallye-2cv-new.webp", "/images/rallye-2cv.webp", "/images/rally-2cv-added.webp"],
  ...
  },
  {
    slug: "raids-vercors",
    name: "Raids Vercors",
    image: "/images/rando-vercors.webp",
    images: ["/images/rando-vercors.webp", "/images/groupe-cascade.webp", "/images/raid-vercors-added.webp"],
  ...
  },
  {
    ...
    image: "/images/gorge-tarn.webp",
    images: ["/images/gorge-tarn.webp", "/images/gorge-tarn-2.webp", "/images/gorge-tarn-3.webp"],
  ...
  },
  {
    ...
    images: ["/images/canyoning.webp", "/images/canyoning-2.webp", "/images/canyoning-3.webp"],
  ...
  },
  {
    slug: "speleologie",
    name: "Spéléologie",
    image: "/images/speleo-image.webp",
    images: [
      "/images/speleo-image.webp",
      "/images/speleo.webp",
      "/images/speleo-2.webp",
      "/images/speleo-4.webp",
      "/images/speleo-5.webp",
      "/images/speleo-6.webp",
      "/images/speleo-7.webp",
      "/images/speleo-8.webp",
      "/images/speleo-bournillon.webp",
    ],
    excerpt: "Explorez les entrailles de la terre en équipe : grottes, passages secrets et émerveillement souterrain.",
    description: "La spéléologie offre une expérience hors du commun pour vos séminaires incentive. Guidés par des spéléologues professionnels, vos équipes s'aventurent dans des grottes et galeries naturelles, franchissent des passages étroits, descendent des puits et découvrent des concrétions millénaires. Une activité qui pousse à se dépasser, à faire confiance à ses coéquipiers et à s'émerveiller d'un monde souterrain méconnu. Latitude Organisation organise vos expéditions dans les massifs du Vercors, des gorges de la Bourniou et de l'Ardèche.",
    duration: "1/2 à journée",
    participants: "8 à 40",
  },
  {
    slug: "buggy",
    name: "Buggy",
    image: "/images/buggy-1.webp",
    images: ["/images/buggy-1.webp", "/images/buggy-2.webp"],
  ...
  },
  {
    slug: "quad",
    name: "Quad",
    image: "/images/quad-1.webp",
    images: ["/images/quad-1.webp", "/images/quad-2.webp", "/images/quad-maroc.webp"],
  ...
  },
  {
    ...
    image: "/images/jetski-corse.webp",
    images: ["/images/jetski-corse.webp"],
  ...
  },
  {
    ...
    image: "/images/char-voile-stmalo.webp",
    images: ["/images/char-voile-stmalo.webp", "/images/char-voile-stmalo-2.webp"],
  ...
  },
  {
    ...
    image: "/images/zodiac-sardaigne.webp",
    images: ["/images/zodiac-sardaigne.webp", "/images/zodiac-sardaigne-2.webp"],
  ...
  },
  {
    slug: "4x4-au-maroc",
    name: "4×4 au Maroc",
    image: "/images/libre-4x4-1.webp",
    images: ["/images/libre-4x4-1.webp", "/images/libre-4x4-2.webp"],
  ...
  },
  {
    slug: "4x4-en-tunisie",
    name: "4×4 en Tunisie",
    image: "/images/4x4-tunisie.webp",
    images: ["/images/4x4-tunisie.webp", "/images/4x4-tunisie-2.webp"],
  ...
  },
  {
    ...
    image: "/images/conference-chamonix-1.webp",
    images: ["/images/conference-chamonix-1.webp", "/images/conference-chamonix-2.webp"],
  ...
  },
  {
    ...
    image: "/images/libre-motoneige-1.webp",
    images: ["/images/libre-motoneige-1.webp", "/images/libre-motoneige-2.webp"],
  ...
  },
  {
    ...
    image: "/images/libre-traineau-1.webp",
    images: ["/images/libre-traineau-1.webp", "/images/libre-traineau-2.webp"],
  ...
  },
  {
    ...
    image: "/images/libre-helicoptere-1.webp",
    images: ["/images/libre-helicoptere-1.webp", "/images/libre-helicoptere-2.webp"],
  ...
  },
  {
    ...
    image: "/images/cheval-camargue-1.webp",
    images: ["/images/cheval-camargue-1.webp", "/images/cheval-camargue-2.webp"],
  ...
  },
  {
    ...
    image: "/images/libre-snorkeling-1.webp",
    images: ["/images/libre-snorkeling-1.webp", "/images/libre-snorkeling-2.webp"],
  ...
  },
  {
    ...
    image: "/images/pilotage-neige-1.webp",
    images: ["/images/pilotage-neige-1.webp", "/images/pilotage-neige-2.webp", "/images/pilotage-neige-3.webp"],
  ...
  },
  {
    ...
    image: "/images/iles-lerins.webp",
    images: ["/images/iles-lerins.webp", "/images/kayak-lerins.webp"],
  ...
  },
  {
    slug: "montgolfiere",
    name: "Montgolfière",
    image: "/images/libre-montgolfiere-1.webp",
    images: ["/images/libre-montgolfiere-1.webp", "/images/libre-montgolfiere-2.webp"],
  ...
  },
  {
    slug: "nuit-en-tipis",
    name: "Nuit en Tipis",
    image: "/images/tipis-1.webp",
    images: ["/images/tipis-1.webp", "/images/nuit-tipis-added.webp"],
...
export const expertiseDetails: ExpertiseDetail[] = [
  {
    ...
    heroImage: "/images/groupe.webp",
    gallery: [
      { src: "/images/koh-lanta-groupe.webp", alt: "Les Aventuriers team-building groupe en plein air" },
      { src: "/images/koh-lanta-equilibre.webp", alt: "Épreuve d'équilibre Les Aventuriers team-building" },
      { src: "/images/koh-lantable-kapla.webp", alt: "Construction Kapla en équipe team-building" },
      { src: "/images/koh-lanta-tir-arc.webp", alt: "Tir à l'arc Les Aventuriers team-building" },
      { src: "/images/koh-lantable-poteaux.webp", alt: "Épreuve des poteaux Koh Lantable team-building" },
      { src: "/images/koh-lantable-puzzle.webp", alt: "Puzzle géant team-building Koh Lantable" },
      { src: "/images/rando-vercors.webp", alt: "Randonnée incentive dans le Vercors avec vue panoramique" },
      { src: "/images/groupe-cascade.webp", alt: "Team-building randonnée groupe sous une cascade" },
      { src: "/images/canyoning.webp", alt: "Canyoning rappel en falaise team-building aventure" },
      { src: "/images/speleo.webp", alt: "Spéléologie team-building groupe en combinaison rouge" },
      { src: "/images/igloo-team.webp", alt: "Construction d'igloos en équipe activité hivernale" },
      { src: "/images/jeux-ferme.webp", alt: "Jeux de la ferme team-building en plein air" },
      { src: "/images/so-british-beatles.webp", alt: "So British team-building thème Beatles" },
      { src: "/images/so-british-croquet.webp", alt: "Croquet anglais So British team-building" },
      { src: "/images/archeo-bilboquet.webp", alt: "Activité archéologie bilboquet médiéval" },
      { src: "/images/archeo-tir-arc.webp", alt: "Tir à l'arc médiéval dans un château en ruines" },
    ],
    sections: [
      {
        ...
        items: [
          ...
          "Team-building urbain : rallyes patrimoniaux, chasse au trésor en ville, défis citadins",
          "Team-building créatif : ateliers cuisine, peinture, beaux-arts, créations artistiques",
      ...
      },
      {
        ...
        items: [
          ...
          "Rallyes & Chasse au trésor : défis patrimoniaux et citadins (Paris, Lyon, Bordeaux…)",
          "Trappeurs & Défis nature : aventures en plein air et cohésion d'équipe",
          "Ateliers créatifs : cuisine, peinture, beaux-arts",
  ...
  },
  {
    ...
    heroImage: "/images/animation-soiree-groupe.webp",
    gallery: [
      { src: "/images/masque-venitien.webp", alt: "Soirée à thème vénitien avec masques et décors somptueux" },
      { src: "/images/casino-roulette.webp", alt: "Animation casino roulette lors d'une soirée d'entreprise" },
      { src: "/images/casino.webp", alt: "Ambiance casino soirée gala entreprise" },
      { src: "/images/presentateurs.webp", alt: "Animateurs soirée thème Gatsby Great Gatsby" },
      { src: "/images/jerome-peaky.webp", alt: "Animation soirée thème Peaky Blinders" },
      { src: "/images/karim-nabil-peaky.webp", alt: "Soirée costumée thème Peaky Blinders" },
      { src: "/images/murder-atelier.webp", alt: "Atelier murder party enquête policière en soirée" },
      { src: "/images/cocktail-spirits.webp", alt: "Atelier cocktail dégustation spiritueux en soirée" },
      { src: "/images/cocktail-setup.webp", alt: "Bar à cocktails lors d'une soirée événementielle" },
    ],
    sections: [
      {
